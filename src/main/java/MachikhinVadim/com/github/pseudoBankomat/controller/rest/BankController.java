...
import MachikhinVadim.com.github.pseudoBankomat.constant.ProjectConstant;
...
public class BankController {
    ...
    public ResponseEntity<String> getUserBalance(
        ...
        return (service.takeMoney(uuid, amount))
                ? new ResponseEntity<>(resultOfTakeMoney + ProjectConstant.SUCCESS_OPERATION, HttpStatus.OK)
                : new ResponseEntity<>(resultOfTakeMoney + ProjectConstant.FAILED_OPERATION, HttpStatus.OK);
    ...
    public ResponseEntity<?> putMoney(
        ...
        return (service.putMoney(uuid, amount))
                ? new ResponseEntity<>(resultOfPutMoney + ProjectConstant.SUCCESS_OPERATION, HttpStatus.OK)
                : new ResponseEntity<>(resultOfPutMoney + ProjectConstant.FAILED_OPERATION, HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> transferMoney(
        ...
        return (service.transferMoney(from, to, amount))
                ? new ResponseEntity<>(resultOfTransfer + ProjectConstant.SUCCESS_OPERATION, HttpStatus.OK)
                : new ResponseEntity<>(resultOfTransfer + ProjectConstant.FAILED_OPERATION, HttpStatus.OK);
    }
    ...
    private LocalDate checkingDate(String date) throws OperationException {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(ProjectConstant.DATE_FORMAT);
        try {
            ...
            errorMessage = String.format("Some problem with date: %s, please use this date format %s",
                    date, ProjectConstant.DATE_FORMAT);
